...
plot([mv_swpred,mv_swpred],[0,0.27],'b--','LineWidth',1)
plot([mv_hss,mv_hss],[0,0.27],'r--','LineWidth',1)
...
plot([mt_swpred,mt_swpred],[0,0.34],'b--','LineWidth',1)
plot([mt_hss,mt_hss],[0,0.34],'r--','LineWidth',1)
